...
public class AppointmentRestController {
	...
	public ResponseEntity<AppointmentResponseDTO> updatePatientByAppointmentId(@PathVariable int appointmentId,
			@PathVariable int patientId) {
		Appointment updatedAppointment = appointmentService.updatePatientByAppointmentId(appointmentId, patientId);
		if (updatedAppointment != null) {
			AppointmentResponseDTO dto = dtoConvertor.convertTo(updatedAppointment);
			return new ResponseEntity<AppointmentResponseDTO>(dto, HttpStatus.OK);
		}
		return null;
	}
